    ...
    while True:
        ...
        if ret_val:
            ...
            if outputs[0] is not None:
                ...
                for i, each in enumerate(online_targets):
                    if each.track_id in outside_tracks:
                        ...
                        if iou_similarity[i, list(outside_tracks.keys()).index(each.track_id)] > \
                            ...
                            # and color-hist similarity is larger than appearance similarity thresh
                            # it shows that these two IDs are consistent
                ...
                # global consistent
                # if the ID (existed tracker) of the box is inconsistent, which ID (outside track) it belongs to
                I2 = []
                for i, each in enumerate(online_targets):
                    if i in I1:
                        continue
